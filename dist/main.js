// Scroll Progress
        ...
        const portfolioItems = Array.from(masonry.querySelectorAll('.masonry-item'));
        const originalOrder = [...portfolioItems];
        ...
        filterBtnContainer.addEventListener('click', (e) => {
            if (e.target.classList.contains('filter-btn')) {
                ...
                if (filterValue === 'all') {
                    const shuffledItems = [...originalOrder];
                    shuffleArray(shuffledItems);
                    renderItems(shuffledItems);
                } else {
                    renderItems(originalOrder);
                    const filteredItems = document.querySelectorAll(`.masonry-item[data-category="${filterValue}"]`);
